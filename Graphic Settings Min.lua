...
--General
Setting2 = 0 --(0 Disabled | 1 Enabled) Enable wet Surface effects 
Setting3 = 0 --(0 Disabled | 1 Enabled) Disable rendering of objects when not visible. (Occlusion CUlling)
Setting4 = 0 --(0 Disabled | 1 Enabled) Use low-detail models on distant objects. (LOD)
Setting5 = 3 --(0 Maximum | 1 High | 2 Standart | 3 Off) Real-time Reflections
Setting6 = 1 --(0 FFXAA | 1 Off) Edge Smoothing (Anti-aliasing)
Setting7 = 1 --(0 High | 1 Normal ) Transparent Lighting Quality
Setting8 = 3 --(0 High | 1 Normal | 2 Low | 3 Off) Grass Quality
Setting9 = 1 --(0 High | 1 Normal) Parallax Occlusion
Setting10 = 1 --(0 High | 1 Normal) Tesselation
Setting11 = 1 --(0 Standart | 1 Off) Glare
Setting12 = 1  --(0 High | 1 Normal) Map Resolution

--Shadows
Setting13 = 1 --(0 Display | 1 Hide) Self
Setting14 = 1 --(0 Display | 1 Hide) Party Members
Setting15 = 1 --(0 Display | 1 Hide) Other NPCs
Setting16 = 1 --(0 Display | 1 Hide) Enemies

--Shadow Quality
Setting17 = 0 --(0 Disabled | 1 Enabled) Use low-detail models on shadows. (LOD)
Setting18 = 2 --(0 High | 1 Normal | 2 Low) Shadow Resolution
Setting19 = 2 --(0 Best | 1 Normal | 2 Off) Shadow Cascading
Setting20 = 1 --(0 Strong | 1 Weak) Shadow Softening

--Texture Detail
Setting21 = 0 --(0 Anisotropic | 1 Trilinear | 2 Bilinear) Texture Filtering
Setting22 = 2 --(0 x16 | 1 x8 | 2 x4) Anisotropic Filtering

--Movement Physics
Setting23 = 2 --(0 Full | 1 Simple | 2 Off) Self
Setting24 = 2 --(0 Full | 1 Simple | 2 Off) Party Members
Setting25 = 2 --(0 Full | 1 Simple | 2 Off) Other NPCs
Setting26 = 2 --(0 Full | 1 Simple | 2 Off) Enemies

--Effects
Setting27 = 0 --(0 Disabled | 1 Enabled) Naturally darken the edges of the screen. (Limb Darkening)
Setting28 = 0 --(0 Disabled | 1 Enabled) Blur the graphics around an object in motion. (Radial Blur)
Setting29 = 4 --(0 HBAO+: Quality | 1 HBAO+: Standart | 2 Strong | 3 Light | 4 Off) Screen Space Ambient Occlusion
Setting30 = 2 --(0 Normal | 1 Low | 2 Off) Glare
Setting31 = 2 --(0 Normal | 1 Low | 2 Off) Water Refraction

--Cinematic Cutscenes
Setting32 = 0 --(0 Disabled | 1 Enabled) Enable depth of field.
